...
var displaynews = function(time,repo,message,i){
	...
	newslist.innerHTML += `<div class="carousel-caption text-center p-100"><font color = "black"><strong><ul>Time: ${time}</ul><ul>Updated repository: ${repo}</ul><ul>Message: "${message}"</ul></strong></font></div>`;
}
